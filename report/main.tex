...
%\vskip -0.15in
\caption{Median, $\sigma_{G}$, and root-mean-square calculated for fields of different stellar density.  }
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.8\columnwidth]{figs/lsst-lsst_spread_plot_N_real_lims.png}
%\vskip -0.15in
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.8\columnwidth]{figs/decaps-decaps_spread_plot_N_real_lims.png}
%\vskip -0.15in
