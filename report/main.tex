...
\hline
visit1 & ra1 & dec1 & magzero1 & visit2 & ra2 & dec2 & magzero2 & d2d \arcec & density & dmjd \\
\hline
...
%The statistical spread epoch-to-epoch ($\sigma_{G}$) is on the level of 0.02 mag,  which is almost twice as large as the spread between processing of the same field by two different pipelines (0.05 mag). 
