...
We summarize the information about the photometric repeatability (epoch-to-epoch within a given pipeline), and offset (pipeline-to-pipeline of the same epoch), by combining information from the middle panels of Figs.~\ref{fig:epoch_lsst_multiplot}, ~\ref{fig:epoch_decaps_multiplot},~\ref{fig:lsst_decaps_dmag}.


Considering one visit, we compare the 
% photometric_spread_1_525846-530012.png

% photometric_spread_2_525846-530012.png

% photometric_spread_3_525846-530012.png

% photometric_offset.png

% photometric_offset_summary.png
