...
% ### Add  table with summary of all DECAPS visits processed by DECAPS pipeline : how the numbers compare, why DECAPS looses way less sources on fig:lsst_count_comparison from raw to clean than LSST .
